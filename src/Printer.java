...
public class Printer {
    ...
    private static void printer() {
        ...
        Team teamOne = new Team("Arsenal", 82, 78);
        Team teamTwo = new Team("Barcelona", 87, 80);
        Team teamThree = new Team("Real M.", 83, 80);
        Team teamFour = new Team("Bayern M.", 84, 79);
        Team teamFive = new Team("Juventus", 81, 80);
        Team teamSix = new Team("P.S.G.", 78, 77);
